...
<p data-visibility='hidden'>View <a href='https://learn.co/lessons/cssi-1.3-html-basics' title='HTML Basics'>HTML Basics</a> on Learn.co and start learning to code for free.</p>
